...
namespace NDMod.Common.Utilities
{
    public class UIHelper
    {
            ...
            Color nonHoverColor = default)
        {
            ...
            Terraria.UI.Chat.ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, FontAssets.DeathText.Value, text, position, hovering ? colorWhenHovered : nonHoverColor, 0f, FontAssets.DeathText.Value.MeasureString(text) / 2, new Vector2(shouldScale ? useScale * 0.4f : 0.4f), -1, 1);
